...
function edit_row(no)
{
 ...
 seller.innerHTML="<select class='addNew' id='new_buyer'><option value='Citi'>Citi</option><option value='JPMorgan'>JPMorgan</option><option value='DeutscheBank'>DeutscheBank</option><option value='GoldmanSach'>GoldmanSachs</option></select>";
}
